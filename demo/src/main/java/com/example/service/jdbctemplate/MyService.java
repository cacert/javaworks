package com.example.service.jdbctemplate;
...
public class MyService {
	...
	public void insertData() {
		...
		jdbcTemplate.execute(
				"INSERT INTO JOURNAL(title,summary,created)VALUES('Spring Boot in the Cloud','Learn Spring Boot using CloudFoundry','2016-01-01 00:00:00.00')");
		log.info("> Done.");
	}
